...
class ApplicationConfig:
    ...
    def _load_config(self):
        config_params = {
            ...
            "SMTP_PORT": (int, 587),
            "SMTP_USERNAME": (None, str),  # Replace None with your email
            "SMTP_PASSWORD": (None, str),
            "SMTP_SENDER": (None, str),
            "SMTP_RECEIVER": (None, str),
            ...
            "YOUTUBE_API_KEY": (None, str),
            "BAIDU_APPID": (None, str),
            "BAIDU_APIKEY": (None, str),
            "BAIDU_SECRETKEY": (None, str),
            "BAIDU_SIGNKEY": (None, str),
            "BAIDU_REDIRECT_URI": (None, str),
            "BAIDU_APP_NAME": (None, str),
            "BAIDU_ACCESS_TOKEN": (None, str),
